...
public class LaptopAndNoteBookSteps {
    ...
    public void iFilledAllMandatoryFieldOfCheckoutPage() throws InterruptedException {
        new CheckOutPage().enterFirstName("Nishit");
        new CheckOutPage().enterLastName("Chitaliya");
        new CheckOutPage().enterEmailId("nishit");
        new CheckOutPage().enterTelephone("07424314233");
        new CheckOutPage().enterAddressLine1("32 studley croft");
        new CheckOutPage().enterCity("Birmingham");
        new CheckOutPage().enterPostCode("B929BQ");
